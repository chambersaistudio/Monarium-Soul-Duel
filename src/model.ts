...
export interface Fighter extends Vec {
  ...
  form: number; cooldown: number; grounded: boolean;
}
...
export function freshFighter(id: FighterId): Fighter {
  return {
    ...
    hp: 100, aura: 55, soul: 0, guard: false, stagger: 0, dodge: 0, attack: 0, attackKind: '', combo: 0,
    comboWindow: 0, form: 0, cooldown: id === 'droplet' ? 1 : 0, grounded: true,
  };
}

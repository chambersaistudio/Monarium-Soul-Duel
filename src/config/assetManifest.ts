...
export const BATTLE_UI_FRAMES = {
  playerPanel: `${UI}/battle/frames/panel_monari_left_empty.png`,
  enemyPanel: `${UI}/battle/frames/panel_monari_right_empty.png`,
...
export const BATTLE_UI_BUTTONS = {
  ...
  capture: `${UI}/battle/buttons/btn_bond.png`,
...
export function getElementIconPath(element?: string): string {
  ...
  return `${UI}/elements/${supported.has(normalized) ? normalized : 'neutral'}.png`;
}
...
export function getGenderIconPath(gender?: string): string {
  ...
  return `${UI}/icons/gender_${safe}.png`;
}
